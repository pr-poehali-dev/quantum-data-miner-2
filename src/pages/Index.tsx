            ...
            <div className="flex flex-col gap-6 max-w-5xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                {[
                  ...
                  { label: "Образование через развлечение", desc: "Мы верим: истинное знание не навязывается — оно раскрывается в игре. Наши квизы превращают изучение спорта в увлекательное путешествие, где факты ложатся на память естественно, без усилий и напряжения." },
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: "«Сарафанное радио» работает на вашу репутацию: участники квизов не просто играют — они становятся амбассадорами заведения. Делятся впечатлениями в соцсетях, зовут друзей и искренне рекомендуют бар тем, кому доверяют. Так формируется круг лояльных гостей и растёт число новых посетителей.",
                },
                {
                  icon: "🗓️",
