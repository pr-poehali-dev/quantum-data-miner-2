            ...
            <div className="flex flex-col gap-6 max-w-5xl">
              <div>
                ...
                <p className="text-foreground font-mono text-sm leading-relaxed">
                  Наша миссия — популяризировать спорт через увлекательные интерактивные форматы, вдохновлять новые поколения на достижение спортивных высот и сохранять память о великих спортсменах, значимых событиях в мире футбола и хоккея. Мы создаём викторины, которые объединяют людей разных возрастов, пробуждают интерес к спорту, показывают примеры выдающихся достижений и мотивируют стремиться к собственным рекордам.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                {[
                  ...
                  { label: "Образование через развлечение", desc: "Мы верим: истинное знание не навязывается — оно раскрывается в игре. Наши викторины превращают изучение спорта в увлекательное путешествие, где факты ложатся на память естественно, без усилий и напряжения." },
                  ...
                  { label: "Доступность", desc: "Начать легко: доступная цена позволяет присоединиться без раздумий, а стартовый уровень сложности — сделать первые шаги даже тем, кто только знакомится с темой." },
        ...
        <section className="px-4 md:px-0 mt-6">
          <div className="rounded-4xl bg-card border border-border px-8 md:px-16 py-12">
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-montserrat)" }}
            >
              Сповик = больше гостей,<br />выше выручка
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: "Работает на вашу репутацию: участники квизов не просто играют — они становятся амбассадорами заведения. Делятся впечатлениями в соцсетях, зовут друзей и искренне рекомендуют бар тем, кому доверяют.",
                },
                {
                  icon: "🗓️",
                ...
                {
                  icon: "🎯",
                  title: "Готовые викторины-тесты",
                  desc: "У нас уже есть готовые викторины по футболу и хоккею. Попробуйте бесплатно в тестовом периоде — без обязательств.",
                },
              ].map((item) => (
